...
public class TimeConverterTest
{
    ...
    private static final String DATETIME_STRING_SECONDS = "20140702 18:03:12";
    private static final DateTime DATETIME_JODA = new DateTime(2014, 7, 2, 18, 3, 0, DateTimeZone.forID("America/Chicago"));
    private static final DateTime DATETIME_JODA_SECONDS = DATETIME_JODA.withSecondOfMinute(12);
    ...
    @Test
    public void readsStringWithSecondsToDateTime() throws Exception
    {
        InputNode inputNode = mock(InputNode.class);
        when(inputNode.getValue()).thenReturn(DATETIME_STRING_SECONDS);

        DateTime actual = converter.read(inputNode);
        assertEquals(DATETIME_JODA_SECONDS, actual);
    }
    ...
    @Test
    public void convertsStringWithSecondsToDateTime() throws Exception
    {
        DateTime actual = TimeConverter.parse(DATETIME_STRING_SECONDS);
        assertEquals(DATETIME_JODA_SECONDS, actual);
    }
